...
const ProductDetailAdvanced = ({ productDetail }) => {
  return (
        ...
        <div className=" px-5 py-24 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <img
              ...
              src={`/images/${productDetail?.images[0].src}`}
            />
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <p className="leading-relaxed">
                {productDetail.description_body ||
                  productDetail.description_short}
              </p>
              <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-200 mb-5">
                ...
                <div className="flex ml-6 items-center">
                  <span className="mr-3">Size/Talla: </span>
            ...
            <div className="w-full md:w-4/6 px-4">
              <div className="md:py-20 px-8 lg:pl-20 lg:pr-10">
                <div className="flex flex-wrap -mx-4">
                  <div className="w-1/3 md:w-1/3 px-4 mb-12 md:mb-0">
                    ...
                    <ul>
                      ...
                      <li className="mb-8">
                        <a
                          ...
                          href="#"
                        >
                          Registrar una queja / Complaints
                        </a>
                      </li>
                      <li className="mb-8">
                        <a
                  ...
                  <div className="w-1/3 md:w-1/3 px-4">
                    <h3 className="mb-8 text-sm text-white uppercase font-heading">
                      Factotum
                    </h3>
                    <ul>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap justify-between">
            <p className="mb-8 md:mb-0 text-gray-500">
              Con carino Desde La tierra Australis © Corro 2023
            </p>
